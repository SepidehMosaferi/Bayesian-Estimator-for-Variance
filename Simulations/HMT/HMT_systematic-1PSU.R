# ==============================================================================
# R Code for the Simulation Studies (HMT case SYSTEMATIC with 1 PSU)
# Date: Feb 2024 
# ==============================================================================
...
# first-order inclusion probabilities (for 1 unit sample selection):
pik <- sapply(1:H,function(i){inclusionprobabilities(DATA$x[DATA$strat==i],1)}) 
DATA$pik <- unlist(pik)
...
ni_PSU <- rep(1,H)  # vector of stratum sample sizes 
